...
export const metadata: Metadata = buildPageMetadata({
  title: "Обо мне",
  description:
    "Галина Оноприенко — дипломированный инструктор нейрографики. 17 лет онлайн-продвижения, 1000+ мастер-классов. Осознанный подход без обещаний «волшебных таблеток».",
  path: "/about",
});
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-muted">
                ...
                Более 17 лет в онлайн-продвижении и более 1000 проведённых мастер-классов.
              </p>
            </div>
      ...
      <section className="relative overflow-hidden section-padding bg-[linear-gradient(180deg,_rgb(235_228_216/0.92),_rgb(235_228_216/0.7))]">
        ...
        <Container className="relative z-10 grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="space-y-6 text-base leading-relaxed text-muted md:text-lg">
            <p>
              Уже более 17 лет я работаю в онлайн-продвижении и убеждена, что именно
              этот формат делает качественные программы доступными для людей
              независимо от того, в каком городе или стране они живут.
            </p>
            <p>
